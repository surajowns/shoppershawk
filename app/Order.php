...
{
    protected $fillable=['order_no','user_id','order_type','price','quantity','total_amount','gst_no','bussiness_name','coupon','discount','billing_name','billing_email','billing_country','billing_state','billing_address','billing_landmark','billing_mobile','billing_pincode','shipping_name','shipping_email','shipping_country','shipping_state','shipping_address','shipping_landmark','shipping_mobile','shipping_pincode','status','order_note','created_at','update_at'];
