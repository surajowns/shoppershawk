...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        <input class="form-control" type="text" name="name" value="" required id="title" placeholder="Enter Name" autocomplete="off">
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        <input class="form-control" type="text" name="email" value="" id="title" placeholder="Enter Email" required autocomplete="off">
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        <input class="form-control" type="text" name="mobile" value="" id="title" placeholder="Enter Mobile" required autocomplete="off">
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        <input class="form-control" type="text" name="location" value="" id="address" placeholder="Enter Location" required  autocomplete="off">
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        <input class="form-control" name="profile_image" type="file" value="" required id="image" placeholder="Enter ">
