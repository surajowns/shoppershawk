...
<div class="page-header">
    <div class="row">
        ...
        <div class="col-auto text-right">
            ...
            <a href="{{url('admin/role/add-role')}}" class="btn btn-primary add-button ml-3">
                ...
                <table class="table table-hover table-center mb-0 datatable">
                        ...
                        <tr>
                               ...
                               <td class="text-center">
                                    <a href="{{url('admin/role/edit-role/'.$cat['id'])}}" class="btn btn-sm bg-success-light mr-2">	<i class="far fa-edit mr-1"></i> Edit</a>
                                    <a class="text-danger btn btn-sm bg-danger-light mr-2" href="{{url('admin/role/delete-role/'.$cat['id'])}}"onclick="return confirm('Are you sure you want to delete?');"> <i class="far fa-trash-alt mr-1"></i>Deleted</a></td>
                                </td>
