        ...
        <div class="profile-header">
            <div class="row align-items-center">
                ...
                <div class="col ml-md-n2 profile-user-info">
                    ...
                    <div class="user-Location"><i class="fas fa-map-marker-alt"></i>&nbsp;&nbsp; {{ucfirst($data['location'])}}</div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title d-flex justify-content-between">
                                    ...
                                    <a class="edit-link btn btn-sm bg-success-light mr-2" data-toggle="modal" href="#edit_personal_details"><i class="far fa-edit mr-1"></i></i>Edit</a>
                                </h5>
                                <div class="row">
                                    <p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Name</p>
                                    <p class="col-sm-9">{{$data['name']}}</p>
                                </div>
                                <!-- <div class="row">
                                    <p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Date of Birth</p>
                                    <p class="col-sm-9">10th Feb 1983</p>
                                </div> -->
                                <div class="row">
                                    <p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Email ID</p>
                                    <p class="col-sm-9">{{$data['email']}}</p>
                                </div>
                                <div class="row">
                                    <p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Mobile</p>
                                    <p class="col-sm-9">{{$data['mobile']}}</p>
                                </div>
                                <div class="row">
                                    <p class="col-sm-3 text-muted text-sm-right mb-0">Address</p>
                                    <p class="col-sm-9 mb-0">{{$data['location']}}</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-10 col-lg-6">
                                ...
                                @csrf
                                    <div class="form-group">
                                        ...
                                        <input type="password" value="" name="current" class="form-control" required>
                                    </div>
                                    <div class="form-group">
