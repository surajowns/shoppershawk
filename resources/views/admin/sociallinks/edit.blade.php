...
<div class="row">
	<div class="col-lg-12">
		<div class="form-group row">
			...
			<div class="col-sm-9">
				<input class="form-control" type="text" name="title" value="{{$editData['title']}}" id="cname" placeholder="Enter Title" required onkeyup = "convertToSlug()" autocomplete="off">
		...
		<div class="form-group row">
			...
			<div class="col-sm-9">
				<input class="form-control" name="links" type="text" value="{{$editData['links']}}" id="links" required placeholder="Enter link ">
