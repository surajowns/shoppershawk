...
<div class="page-header">
    <div class="row">
        ...
        <div class="col-auto text-right">
            ...
            <a href="{{url('admin/social/add-social')}}" class="btn btn-primary add-button ml-3">
            ...
            <div class="card-body">
                ...
                <table class="table table-hover table-center mb-0 datatable">
                        ...
                        <tr>
                               ...
                               <td>{{$cat['title']}}</td>
                               <td class="text-center">{{$cat['links']}}</td>
                               <td><a class="text-primary" href="{{url('/admin/update-status/social_links/'.$cat['id'].'/'.$cat['status'])}}">{{$cat['status']==1?'Active':'Inactive'}}</a></td>
                               <td class="text-right">
                                    <a href="{{url('admin/social/edit-social/'.$cat['id'])}}" class="btn btn-sm bg-success-light mr-2">	<i class="far fa-edit mr-1"></i> Edit</a>
                                    <a class="text-danger btn btn-sm bg-danger-light mr-2" href="{{url('admin/social/delete-social/'.$cat['id'])}}"onclick="return confirm('Are you sure you want to delete?');"> <i class="far fa-trash-alt mr-1"></i>Deleted</a></td>
                                </td>
