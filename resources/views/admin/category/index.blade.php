                        ...
                        <tbody>
                            @foreach($categories as $cat)
                                <tr>
                                    ...
                                    <td>{{$cat['name']}}</td>
                                    <td>
                                        <img class="mr-1" src="{{url('public/category/'.$cat['image'])}}" alt="Category Image" width="200px">
                                    </td>
                                    ...
                                    <td class="text-right">
                                            ...
                                            <a class="text-danger btn btn-sm bg-danger-light mr-2" href="{{url('admin/category/delete-category/'.$cat['id'])}}"onclick="return confirm('Are you sure you want to delete?');"> 
                                                <i class="far fa-trash-alt mr-1"></i>Deleted</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
