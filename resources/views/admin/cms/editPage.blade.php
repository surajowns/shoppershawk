                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control" type="text" name="title"  id="cname" placeholder="Enter Name" onkeyup = "convertToSlug()" value="{{$page['title']}}" autocomplete="off">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control" name="slug" type="text" value="{{$page['title']}}" id="slug" placeholder="Enter Slug">
