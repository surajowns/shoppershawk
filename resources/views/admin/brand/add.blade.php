...
<div class="row">
	<div class="col-lg-12">
		<div class="form-group row">
			...
			<div class="col-sm-9">
				<input class="form-control" type="text" name="name" value="" id="cname" placeholder="Enter Name" required onkeyup = "convertToSlug()" autocomplete="off">
		...
		<div class="form-group row">
			...
			<div class="col-sm-9">
				<input class="form-control" name="images" type="file" value="" id="image" required placeholder="Enter ">
