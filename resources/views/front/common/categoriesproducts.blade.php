<?php
  $cateproduct=App\CategoryModel::with('products')->where('parent_id','!=',0)->where('status',1)->get()->toArray();
//   $product=App\Product::with('productImage')->where('supercategory_id',2)->where('status',1)->get()->toArray();
...
<div class="small_product_area small_product_style2">
    <div class="container">
        <div class="row">
            @foreach($cateproduct as $productsdetails)
            <div class="col-lg-4">
                <div class="small_product_list">
                    ...
                    <div class="product_items">
                            ...
                            <figure class="single_product">
                                ...
                                <a class="primary_img" href="#"><img class="best-selling" src="{{url('public/product_image/')}}" alt="" /></a>
                                </div>
