                    ...
                    <div class="col-lg-6 offset-lg-3 col-md-12">
                        <div class="swiper-container gallery-top">
                            <div class="slider_area swiper-wrapper">
                                <div class="single_slider swiper-slide d-flex align-items-center" data-bgimg="front/img/slider/slider1.jpg">
                                ...
                                <div class="single_slider swiper-slide d-flex align-items-center" data-bgimg="front/img/slider/slider2.jpg">
                                    <div class="slider_content">
                                        <h3>big sale products</h3>
                                        <h1>
                                            wooden minimalist <br />
                                            chair 2019
                                        </h1>
                                ...
                                <div class="single_slider swiper-slide d-flex align-items-center" data-bgimg="front/img/slider/slider3.jpg">
                                ...
                                <div class="single_slider swiper-slide d-flex align-items-center" data-bgimg="front/img/slider/slider4.jpg">
                                    <div class="slider_content color_white">
                                        <h3>new arrivals</h3>
                                        <h1>
                                            cellphone <br />
