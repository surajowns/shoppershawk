                                            ...
                                            <td>
                                                <table width="600" border="0" cellpadding="10" cellspacing="0" style="border:1px solid #ccc">
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <tr>
                                                            <td colspan="5" style="border-right:1px solid #ccc;border-top:1px solid #ccc"><strong>Discount</strong></td>
                                                            <td align="center" style="border-top:1px solid #ccc;border-right:1px solid #ccc;"><strong>₹ {{number_format($orders['discount'],2)}}</strong></td>
                                                        </tr>
                                                        <tr>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td align="left" valign="top">
                                                                ...
                                                                <p>Team,
                                                                    <br> <a href="{{url('/')}}" target="_blank" >Shoppershawk</a> </p>
                                                            </td>
