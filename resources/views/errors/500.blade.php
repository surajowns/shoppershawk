...
<head>
        ...
        <title>Shoppershawk | ERROR</title>
    ...
    <body class="error-page">
        ...
        <div class="main-wrapper">
			...
			<div class="error-box">
				...
				<!-- <a href="{{url('public//admin/login')}}" class="btn btn-primary">Back to Home</a> -->
			</div>
		...
		<!-- jQuery -->
        <script src="{{url('public/assets/js/jquery-3.2.1.min.html')}}"></script>
		
		<!-- Bootstrap Core JS -->
        <script src="{{url('public/admin/assets/js/popper.min.js')}}"></script>
        <script src="{{url('public/admin/assets/js/bootstrap.min.html')}}"></script>
		
		<!-- Custom JS -->
		<script  src="{{url('public/admin/assets/js/script.html')}}"></script>
